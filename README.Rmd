...
- **`quantize_null()`**: Generate null distributions with optional parallelization
...
`nullcat` complements these packages by extending null model capabilities to categorical and stratified quantitative data.
